...
import { AddSecurityEventFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-9/2-9-instance-command-fast-1785152244467-add-security-event';
...
export const INSTANCE_COMMANDS = [
  ...
  AddSecurityEventFastInstanceCommand,
];
