...
// Wildcard pre-hook for *.findOne. See generic-rls-find-many.pre-query.hook.ts
// for the design rationale (wildcard key, fail-closed-by-omission, AND-merge
// composition with the per-object hooks during the overlap window).
@WorkspaceQueryHook(`*.findOne`)
export class GenericRlsFindOnePreQueryHook
