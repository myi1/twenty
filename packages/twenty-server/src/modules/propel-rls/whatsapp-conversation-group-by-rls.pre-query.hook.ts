...
// Propel clean-room RLS — whatsAppConversation.groupBy.
@WorkspaceQueryHook(`whatsAppConversation.groupBy`)
export class WhatsAppConversationGroupByRlsPreQueryHook
