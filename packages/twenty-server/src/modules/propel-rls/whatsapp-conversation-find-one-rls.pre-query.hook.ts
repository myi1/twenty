...
// Propel clean-room RLS — whatsAppConversation.findOne.
@WorkspaceQueryHook(`whatsAppConversation.findOne`)
export class WhatsAppConversationFindOneRlsPreQueryHook
