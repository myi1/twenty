...
// Propel clean-room RLS — timelineActivity.groupBy. Owner field is `workspaceMemberId`.
@WorkspaceQueryHook(`timelineActivity.groupBy`)
export class TimelineActivityGroupByRlsPreQueryHook implements WorkspacePreQueryHookInstance {
