...
// Propel clean-room RLS — timelineActivity.findOne. Owner field is `workspaceMemberId`.
@WorkspaceQueryHook(`timelineActivity.findOne`)
export class TimelineActivityFindOneRlsPreQueryHook implements WorkspacePreQueryHookInstance {
