...
// Propel fork: the execution context resolves the host color scheme on the main
// thread (the worker sandbox has no matchMedia) — mock both theme hooks.
jest.mock('@/ui/theme/hooks/useColorScheme', () => ({
  useColorScheme: () => ({ colorScheme: 'Light' }),
}));

jest.mock('@/ui/theme/hooks/useSystemColorScheme', () => ({
