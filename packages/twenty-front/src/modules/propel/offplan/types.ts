...
export type OffplanBrowseFilters = {
  ...
  // "Available projects" toggle. Project status is authoritative here.
  // unitCount is inventory coverage, not availability: zero can mean the
  // upstream source has not supplied unit rows for this developer/project.
  stockedOnly: boolean;
